...
class ActorNet(nn.Module):
    def __init__(self, state_dim=8, action_dim=2, hidden_dim=(32, 32)):
        super().__init__()
        ## TODO ##
        # raise NotImplementedError
...
class DDPG:
    def __init__(self, args):
        ...
        ## TODO ##
        self._actor_opt  = op.Adam(self._actor_net.parameters() , lr=args.lra)
        self._critic_opt = op.Adam(self._critic_net.parameters(), lr=args.lrc)
        # raise NotImplementedError
        # action noise
